<template>
  <span v-if="isShowElement">
    <el-popover
      ...
      <el-collapse v-if="!searchMode" class="qqt-icon-select--group" v-model="collapseActive">
      ...
      <div v-if="searchMode" class="qqt-icon-select--group">
  ...
  <qqt-p v-else :class="'fa fa-' + value"></qqt-p>
</template>
