    ...
    <div style="padding:10px 20px 20px 20px;" class="voucher">
		...
		<el-row style="width:960px;margin: 20px auto 10px;height:45px;line-height:45px">
			...
			<el-col :span="5" style="text-align: right;">
				<span style="font-size:16px">日期：{{inputtime}}</span>
					<!-- <el-date-picker
					style="width:150px"
					v-model="inputtime"
					type="date"
			...
			<el-col :span="5" style="text-align: right;">
				...
				<span style="font-size:16px;display:inline-block;width:50px;text-align:center">{{doc}}</span>
            ...
            <tbody>
                <tr v-for="(item, index) in dataList" :key="index">
                    ...
                    <td class="selectClass" style="padding:0;vertical-align: top">
                        <div >
                            <div style="height:35px;text-align:left;padding: 0 5px;" >
