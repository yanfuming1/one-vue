    ...
    <d2-container class="address-book open-tender">
        <el-card class="box-card closeHeader">
            ...
            <div class="drawer-btn">
                <!-- <el-button type="warning" v-if="!transform.isShowDetails" size="small" @click="subNewPro">保存</el-button> -->
...
import { synopsisList, returnAdd } from '../../../../../api/materialEquipmentManagement/receiveManagement/receiveApply/index'
...
export default {
    ...
    methods: {
        ...
        getJson () {
            formGetJson({
                code: MATERIALEQUIPMENTMANAGEMENT.RETURNADD
            }).then(res => {
