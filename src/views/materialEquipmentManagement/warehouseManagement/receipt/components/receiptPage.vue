    ...
    <d2-container>
        <div slot="header" class="purchase-warehousing-page">
            <el-form :inline="true" :model="form" ref="form" size="mini" @submit.native.prevent>
                <el-form-item>
                    <el-button type="primary" @click="addReceiptPageEven">添加</el-button>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button-group>
                        ...
                        <el-button size="mini" @click="" icon="el-icon-printer">打印</el-button>
                    </el-button-group>
                </el-form-item>
        ...
        <div class="purchase-warehousing-conent">
            <qqt-table :data="resignationApplicationData" :option="tableOption" :dynamicHeader="dynamicHeader" :rowHeader="rowHeader" @selectionChange="selectChange" @page="handlePaginationChange"></qqt-table>
        </div>
