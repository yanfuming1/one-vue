<template>
    <div :class="wrapClasses">
        ...
        <div v-if="append" class="ivu-input-group-append"><slot name="append"><span>元</span></slot></div>
    </div>
</template>
<script>
            ...
            blur () {
                ...
                if (arr.length > 0) {
                    if (this.currentValue) {
                        this.currentValue = (this.currentValue-0).toFixed(2)
                    }
                } 
                this.focused = false;
                this.$emit('on-blur');
                if (!this.findComponentUpward(this, ['DatePicker', 'TimePicker', 'Cascader', 'Search'])) {
