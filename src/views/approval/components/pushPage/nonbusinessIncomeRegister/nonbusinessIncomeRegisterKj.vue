            ...
            <el-card :body-style="{ padding: '20px' }">
                ...
                <el-row>
                  <el-col :span="24" style="text-align:center" class="d2-mt-20">
                      <qqt-voucher ref="voucher" :voucherShow="voucherShow" @dialogComfirm="dialogComfirm" @dialogCancel="voucherShow=false" :data="queryData" ></qqt-voucher>
...
        },
    ...
    methods: {
      ...
      getJson() {
        formGetJson({
            code: 'nonbusinessIncomeRegisterKj'
        }).then(res => {
