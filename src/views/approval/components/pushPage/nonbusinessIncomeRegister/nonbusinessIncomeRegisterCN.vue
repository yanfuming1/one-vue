          ...
          <template slot="content">
            <el-card :body-style="{ padding: '20px' }">
                ...
                <!-- <div class="add-customer-content___upload">
                    <label for="male">
                        <upload id="male"   ref="upLoad" :isShowUpload="false" @upLoadFileCallBack="upLoadFileCallBack" :propList="upLoadFileDefaultList"></upload>
                    </label>
                </div> -->
                ...
                <el-row>
                  <el-col :span="24" style="text-align:center" class="d2-mt-20">
                      <qqt-look-voucher  :data="queryData" ref="voucherCn"></qqt-look-voucher>
...
        },
    ...
    methods: {
      ...
      getJson() {
        formGetJson({
            code: 'nonbusinessIncomeRegisterCN'
        }).then(res => {
