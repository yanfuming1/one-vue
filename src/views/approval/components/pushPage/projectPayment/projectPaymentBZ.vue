                        ...
                        <div class="retuern-content">
                            ...
                            <el-tabs v-model="activeName" type="card"> 
                                <el-tab-pane :label="label1" name="first">
                                    <addline1 :isShowDetails='isShowDetails' :isSendBack="isSendBack" :showAddName="showAddName" :costType="costType" :title="addTitle" :isProcess='isProcess' @change="addLineChange1" :dataInfo='addLineData1' :showReject='showReject' ref="addline1"></addline1>
                                </el-tab-pane>
                                <el-tab-pane :label="label2" name="second">
                                    <addline1 :isShowDetails='isShowDetails' :isSendBack="isSendBack" :showAddName="showAddName" :costType="costType" :title="addTitle1" :isProcess='isProcess' @change="addLineChange2" :dataInfo='addLineData2' :showReject='showReject' ref="addline2"></addline1>
                                </el-tab-pane>
                                <el-tab-pane :label="label3" name="third">
                                    <pay-add-line :isShowDetails='isShowDetailsNew' @change="addLineChange3" :associatedPersonId='associatedPersonId' :dataInfo='addLineData3' ref="addline3"></pay-add-line>
                                </el-tab-pane>
                            </el-tabs>
                        </div>
                        <div>
    ...
    methods: {
        ...
        consentBorrowingApply(item = '', boolean = false){
            ...
            if (item) {
                ...
                tem.advisoryList = this.$refs.advisoryList.getData()
        ...
        consentFun () {
            ...
            let canSub = true
            try{
                if (tem.advisoryList.length > 0) {
                    tem.advisoryList.forEach(item => {
                        if (item.line1 === '' || item.line2 === '' || item.line3 === '') {
                            canSub = false
                            this.$message.warning("请补全咨询登记内容!!!")
