        ...
        <template slot="header">
            <div class="qqt-container-full-header___top">
                ...
                <span class="qqt-container-full-header-operation___left">
                    <el-button type="primary" class="qqt-container-full-header-top___button" @click="addQualityBrightSpot">添加</el-button>
                </span>
                ...
                <span class="qqt-container-full-header-operation___right">
                    <el-button type="primary" class="qqt-container-full-header-top___button" @click="deleteQualityBrightSpotList">批量删除</el-button>
                </span>
                <span class="qqt-container-full-header-operation___right">
                    <el-button-group>
...
<script>
    import { getQualityBrightSpotPageList, deleteBatchQualityBrightSpot } from '@/api/selfProject/qualityManagement/qualityBrightSpot'
    ...
    export default {
                            ...
                            return h('div', {
                                ...
                                on:{
                                    click: () => {
                                        ...
                                        this.routerLink ('质量亮点详情', parms.row.id)
                                    }
                                }
                            }, parms.row.featureNumber)
                        }
                    },
                    {
                        prop: 'divideName',
                                ...
                                h('el-button', {
                                    ...
                                    on:{
                                        click: () => {
                                            ...
                                            this.routerLink ('质量亮点编辑', parms.row.id)
                                        }
                                    }
                                }, '编辑'),
                                h('el-button', {
                                    ...
                                    on:{
                                        click: () => {
                                            this.deleteQualityBrightSpotObject (parms.row.id)
                                        }
                                    }
                                }, '删除')
                            ]
        ...
        methods: {
            ...
            getQualityBrightSpotPage (text) {
                getQualityBrightSpotPageList ({
                    ...text,
            ...
            deleteQualityBrightSpotObject (id) {
                this.deleteQualityBrightSpotById ({'ids': id})
            },

            deleteQualityBrightSpotList () {
                ...
                this.deleteQualityBrightSpotById ({'ids': ids.substring(0, ids.length - 1)})
            },

            deleteQualityBrightSpotById (id) {
                util.confirm ().then (boolean => {
                    if (boolean) {
                        deleteBatchQualityBrightSpot (id).then(res => {
                            if (res.code === 200) {
            ...
            addQualityBrightSpot () {
                this.transform.isShowDetails = false
                this.routerLink ('添加质量亮点')
            },
