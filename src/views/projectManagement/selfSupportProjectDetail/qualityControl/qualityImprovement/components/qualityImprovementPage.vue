...
<script>
import { selfRectifyPageList, selfRectifyDel } from '@/api/selfProject/qualityManagement/qualityImprovement/index'
                        ...
                        return h('div', {
                            ...
                            on:{
                                click: () => {
                                    ...
                                    this.routerLink ('质量检查整改详情', parms.row.id)
                                }
                            }
                        }, parms.row.rectifyNumber)
                    }
                },
                {
                    prop: 'divideName',
                            ...
                            h('el-button', {
                                ...
                                on:{
                                    click: () => {
                                        ...
                                        this.routerLink ('编辑质量整改记录', parms.row.id)
                                    }
                                }
                            }, '编辑'),
                            h('el-button', {
