        ...
        <template slot="header">
            <div class="qqt-container-full-header___top">
                ...
                <span class="qqt-container-full-header-operation___left">
                    <el-button type="primary" class="qqt-container-full-header-top___button" @click="addBlueprintAudit">添加</el-button>
                </span>
                ...
                <span class="qqt-container-full-header-operation___right">
                    <el-button type="primary" class="qqt-container-full-header-top___button" @click="deleteBlueprintAuditList">批量删除</el-button>
                </span>
                <span class="qqt-container-full-header-operation___right">
                    <el-button-group>
...
<script>
    import { getBlueprintAuditPageList, deleteBatchBlueprintAudit } from '@/api/selfProject/operatingReserve/blueprintAudit'
    ...
    export default {
                            ...
                            return h('div', {
                                ...
                                on:{
                                    click: () => {
                                        ...
                                        this.routerLink ('图纸会审详情', parms.row.id, parms.row.procInstId)
                                    }
                                }
                            }, parms.row.auditCode)
                        }
                                ...
                                h('el-button', {
                                    ...
                                    on:{
                                        click: () => {
                                            ...
                                            this.routerLink ('图纸会审编辑', parms.row.id, parms.row.procInstId)
                                        }
                                    }
                                }, '编辑'),
                                h('el-button', {
                                    ...
                                    on:{
                                        click: () => {
                                            this.deleteBlueprintAuditObject (parms.row.id)
                                        }
                                    }
                                }, '删除')
                            ]
        ...
        methods: {
            ...
            getBlueprintAuditPage (text) {
                getBlueprintAuditPageList ({
                    ...text,
            ...
            deleteBlueprintAuditObject (id) {
                this.deleteBlueprintAuditById ({'ids': id})
            },

            deleteBlueprintAuditList () {
                ...
                if (this.tableSelectData && this.tableSelectData.length > 0) {
                    this.tableSelectData.forEach(res => {
                        ids += res.id + ','
                        if (res.procState !== '1') procInName += res.auditCode + ',' 
                    })
                }
                ...
                this.deleteBlueprintAuditById ({'ids': ids.substring(0, ids.length - 1)})
            },

            deleteBlueprintAuditById (id) {
                util.confirm ().then (boolean => {
                    if (boolean) {
                        deleteBatchBlueprintAudit (id).then(res => {
                            if (res.code === 200) {
