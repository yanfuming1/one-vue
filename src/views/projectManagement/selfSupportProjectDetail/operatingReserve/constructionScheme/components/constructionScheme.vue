        ...
        <template slot="header">
            <div class="qqt-container-full-header___top">
                ...
                <span class="qqt-container-full-header-operation___left">
                    <el-button type="primary" class="qqt-container-full-header-top___button" @click="addConstructionScheme">添加</el-button>
                </span>
                ...
                <span class="qqt-container-full-header-operation___right">
                    <el-button type="primary" class="qqt-container-full-header-top___button" @click="deleteConstructionSchemeList">批量删除</el-button>
                </span>
                <span class="qqt-container-full-header-operation___right">
                    <el-button-group>
...
<script>
    import { getConstructionSchemePageList, deleteBatchConstructionScheme } from '@/api/selfProject/operatingReserve/constructionScheme'
    ...
    export default {
                            ...
                            return h('div', {
                                ...
                                on:{
                                    click: () => {
                                        ...
                                        this.routerLink ('施工方案详情', parms.row.secondId, parms.row.procInstId)
                                    }
                                }
                            }, parms.row.code)
                        }
                                ...
                                h('el-button', {
                                    ...
                                    on:{
                                        click: () => {
                                            ...
                                            this.routerLink ('施工方案编辑', parms.row.secondId, parms.row.procInstId)
                                        }
                                    }
                                }, '编辑'),
                                h('el-button', {
                                    ...
                                    on:{
                                        click: () => {
                                            this.deleteConstructionSchemeObject (parms.row.id)
                                        }
                                    }
                                }, '删除')
                            ]
        ...
        methods: {
            ...
            searchModelSynopsis (boolean = true) {
                ...
                this.getConstructionSchemePage ({
            ...
            getConstructionSchemePage (text) {
                getConstructionSchemePageList ({
                    ...text,
            ...
            deleteConstructionSchemeObject (id) {
                this.deleteConstructionSchemeById ({'ids': id})
            },

            deleteConstructionSchemeList () {
                ...
                if (this.tableSelectData && this.tableSelectData.length > 0) {
                    this.tableSelectData.forEach(res => {
                        ids += res.id + ','
                        if (res.procState !== '1') procInName += res.name + ',' 
                    })
                }
                ...
                this.deleteConstructionSchemeById ({'ids': ids.substring(0, ids.length - 1)})
            },

            deleteConstructionSchemeById (id) {
                util.confirm ().then (boolean => {
                    if (boolean) {
                        deleteBatchConstructionScheme (id).then(res => {
                            if (res.code === 200) {
