        ...
        <template slot="header">
            <div class="qqt-container-full-header___top">
                ...
                <span class="qqt-container-full-header-operation___left">
                    <el-button type="primary" class="qqt-container-full-header-top___button" @click="addSubcontractManagement">添加</el-button>
                </span>
                ...
                <span class="qqt-container-full-header-operation___right">
                    <el-button type="primary" class="qqt-container-full-header-top___button" @click="deleteSubcontractManagementList">批量删除</el-button>
                </span>
                <span class="qqt-container-full-header-operation___right">
                    <el-button-group>
...
<script>
    import { getSubcontractManagementPageList, deleteBatchSubcontractManagement } from '@/api/selfProject/operatingReserve/subcontractManagement'
    ...
    export default {
            ...
            return {
                ...
                rowHeader: [
                            ...
                            return h('div', {
                                ...
                                on:{
                                    click: () => {
                                        ...
                                        this.routerLink ('分包管理详情', parms.row.id, parms.row.procInstId)
                                    }
                                }
                            }, parms.row.idNumber)
                        }
                    ...
                    },
                    {
                        ...
                        isShow: true,
                        render: (h, parms) => {
                            return h('div',  util.moneyTransform(parms.row.totalMoney))
                         }
                    },
                    {
                        prop: 'createName',
                                ...
                                h('el-button', {
                                    ...
                                    on:{
                                        click: () => {
                                            ...
                                            this.routerLink ('分包管理编辑', parms.row.id, parms.row.procInstId)
                                        }
                                    }
                                }, '编辑'),
                                h('el-button', {
                                    ...
                                    on:{
                                        click: () => {
                                            this.deleteSubcontractManagementObject (parms.row.id)
                                        }
                                    }
                                }, '删除')
                            ]
        ...
        methods: {
            ...
            searchModelSynopsis (boolean = true) {
                ...
                this.getSubcontractManagementPage ({
            ...
            getSubcontractManagementPage (text) {
                getSubcontractManagementPageList ({
                    ...text,
            ...
            deleteSubcontractManagementObject (id) {
                this.deleteSubcontractManagementById ({'ids': id})
            },

            deleteSubcontractManagementList () {
                ...
                if (this.tableSelectData && this.tableSelectData.length > 0) {
                    this.tableSelectData.forEach(res => {
                        ids += res.id + ','
                        if (res.procState !== '1') procInName += res.subContractorName + ',' 
                    })
                }
                ...
                this.deleteSubcontractManagementById ({'ids': ids.substring(0, ids.length - 1)})
            },

            deleteSubcontractManagementById (id) {
                util.confirm ().then (boolean => {
                    if (boolean) {
                        deleteBatchSubcontractManagement (id).then(res => {
                            if (res.code === 200) {
            ...
            addSubcontractManagement () {
                this.transform.isShowDetails = false
                this.routerLink ('添加分包管理')
            },
