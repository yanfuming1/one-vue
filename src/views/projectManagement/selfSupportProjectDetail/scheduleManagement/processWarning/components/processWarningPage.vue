        ...
        <template slot="header">
            <div class="qqt-container-full-header___top">
                ...
                <!-- <span class="qqt-container-full-header___search">
                    <el-input placeholder="请输入内容" prefix-icon="el-icon-search" @keyup.enter.native="searchModelSynopsis" v-model="filterText" size="mini"></el-input>
...
<script>
import { selfSchedulePlanOrderedList } from '@/api/selfProject/scheduleManagement/schedulePlan/index';
    ...
    data () {
        return {
            ...
            rowHeader: [
                ...
                // },
                {
                    prop: 'prepositionTaskName',
                    label: '前置任务',
                    isShow: true,
                    width: 180,
                    // render: (h, parms) => {
                    //     return h('span', {}, parms.row.prepositionTaskName)
                    // }
                },
                {
                    prop: 'planLimit',
