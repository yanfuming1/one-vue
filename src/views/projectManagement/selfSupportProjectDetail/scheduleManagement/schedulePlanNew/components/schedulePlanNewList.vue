...
<script>
import { selfSchedulePlanNewPageList, selfSchedulePlanNewDel } from '@/api/selfProject/scheduleManagement/schedulePlanNew/index'
                        ...
                        return h('div', {
                            ...
                            on:{
                                click: () => {
                                    ...
                                    this.routerLink ('进度追踪详情', parms.row.id)
                                }
                            }
                        }, parms.row.untitled1)
                    }
                            ...
                            h('el-button', {
                                ...
                                on:{
                                    click: () => {
                                        ...
                                        this.routerLink ('编辑进度追踪', parms.row.id)
                                    }
                                }
                            }, '编辑'),
                            h('el-button', {
    ...
    methods: {
        ...
        deleteIndexById (id) {
            util.confirm ().then (boolean => {
                if (boolean) {
                    selfSchedulePlanNewDel (id).then(res => {
                        if (res.code === 200) {
