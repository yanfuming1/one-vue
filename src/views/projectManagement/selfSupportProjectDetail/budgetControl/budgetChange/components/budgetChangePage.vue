...
<script>
import { budgetChangeSearchPageList, budgetChangeDel } from '@/api/selfProject/budgetControl/budgetChange'
import { deleteBatchBudgetInfo } from '@/api/selfProject/budgetControl/budgetInfo'
                        ...
                        return h('div', {
                            ...
                            on:{
                                click: () => {
                                    ...
                                    this.routerLink ('预算变更信息详情', parms.row.id)
                                }
                            }
                            ...
                            h('el-button', {
                                ...
                                on:{
                                    click: () => {
                                        ...
                                        this.routerLink ('预算变更信息编辑', parms.row.id)
                                    }
                                }
                            }, '编辑'),
                            h('el-button', {
