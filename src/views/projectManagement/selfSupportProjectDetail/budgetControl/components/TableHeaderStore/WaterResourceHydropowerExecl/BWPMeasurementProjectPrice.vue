<template>
  <div class="BWP-con-div3">
    <h3 style="text-align:center">措施项目清单计价表</h3>
...
.BWP-con-div3{
  ...
  .headerClass{
    width: 100%!important;
    th:nth-child(1) { width: 20%!important; }
    th:nth-child(2) { width: 50%!important; }
    th:nth-child(3) { width: 30%!important; }
  }
  .el-table__body{
    .el-table__row{
      td:nth-child(1) { width: 20%!important; }
      td:nth-child(2) { width: 50%!important; }
      td:nth-child(3) { width: 30%!important; }
    }
  }
  .table-div{
