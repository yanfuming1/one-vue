<template>
  <div class="BWP-con-div12">
    <h3 style="text-align:center">{{ datasource.title }}</h3>
...
.BWP-con-div12{
  ...
  .headerClass{
    ...
    th:nth-child(5) { width: 20%!important; }
  }
  .el-table__body{
    .el-table__row{
      ...
      td:nth-child(4) { width: 20%!important; }
      td:nth-child(5) { width: 20%!important; }
    }
  }
  .table-div{
