    ...
    <d2-container type="fulls" class="addResponsibilityCost">
        <el-card class="box-card closeHeader">
                ...
                <qqt-flow-tabs :procInstId="procInstId">
                    <template slot="content">
                        ...
                        <div class="add-responsibility-cost-price">
                            ...
                            <span> 经审定，责任成本为 {{ values.targetResponsibilityCost }}元 </span>
                        </div>
            ...
            <div class="qqt-container-full-content___button">
                <!-- {{ stutas }} {{ !transform.isShowDetails }} {{ procInstId }} -->
    ...
    export default {
        ...
        data () {
            return {
                ...
                code: BASICSCODE.COST_TARGET_RESPONSIBILITY1,
                processModule: PROPRIETARYPROJECT.ADDRESPONSIBILITYCOST,
                dialogVisible: false,
                // identification: ''
            }
        },
        ...
        methods: {
            ...
            getExportExcel () {
                ...
                let sheetFilterData = ['code', 'name', 'feature', 'unit', 'num', 'unitPrice',
                    'totalPrice', 'adjustNumber',  'adjustUnitPrice',  'adjustTotalPrice', 'remark'];
                let sheetHeaderData = ['项目编码', '项目名称', '项目特征', '计量单位', '投标数量', '投标单价（元）',
                    '投标合价（元）', '核算数量',  '核算单价（元）', '核算合价（元）', '备注'];
                option.datas = [{
