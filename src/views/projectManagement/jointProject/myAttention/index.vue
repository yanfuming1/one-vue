<template>
    <d2-container class="address-book">
        ...
        <div class="address-book-center">
            <qqt-table :data="tableData" :rowHeader="rowHeader" :option="tableOption" :dynamicHeader="dynamicHeader" @selectionChange="selectChange" @page="handlePaginationChange"></qqt-table>
        </div>
    </d2-container>
</template>
...
import { jointAttentionList,getProById,jointScopeAddOrCancelAttention,getProjectAllOptions  } from '../../../../api/jointProject/index'
...
export default {
    ...
    methods: {
        ...
        getTableData () {
            jointAttentionList(this.filterForm).then(res => {
                this.tableData = res
            })
        }
    },
