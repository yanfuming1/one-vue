                        ...
                        <el-form ref="form" class="header-form" :model="filterForm" label-width="120px">
                            ...
                            <el-col :span="12">
                                <el-form-item label="联营负责人:">
                                    <el-select v-model="filterForm.jointPrincipal" clearable size="mini" style="width:100%;" @change="searchModelSynopsis" placeholder="请选择">
...
import { allCustomerList,jointCreateList,getProById, jointScopeAddOrCancelAttention,getProjectAllOptions } from '../../../../api/jointProject/index'
...
export default {
    ...
    methods: {
        ...
        getTableData () {
            jointCreateList(this.filterForm).then(res => {
                this.tableData = res
            })
        }
    },
...
.address-book {
    ...
    .el-range__close-icon{ line-height: 22px; }
    .address-book-header {
        .el-date-editor{
            width: 300px;
            height: 30px;
