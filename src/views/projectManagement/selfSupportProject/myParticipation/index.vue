...
import { getSelfProjectParticipantList, selfProjectDelete, getSelfProjectHighestVersion, updataSelfProjectAttention} from '../../../../api/selfProject/allProject/index'
...
export default {
    ...
    methods: {
        ...
        searchModelSynopsis(pageNo = '1', pageSize = '10') {
            ...
            getSelfProjectParticipantList(this.filterForm).then(res => {
                this.tableData = res
            })
        },
        ...
        getList(){
            getSelfProjectParticipantList().then(res => {
                this.tableData = res
            })
        },
        shareProject(){
