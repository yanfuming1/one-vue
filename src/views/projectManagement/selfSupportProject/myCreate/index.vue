...
import { getSelfProjectCreateList, selfProjectDelete, getSelfProjectHighestVersion, updataSelfProjectAttention} from '../../../../api/selfProject/allProject/index'
...
export default {
    ...
    methods: {
        ...
        searchModelSynopsis(pageNo = '1', pageSize = '10') {
            ...
            getSelfProjectCreateList(this.filterForm).then(res => {
                this.tableData = res
            })
        },
        ...
        getList(){
            getSelfProjectCreateList().then(res => {
                this.tableData = res
            })
        },
        shareProject(){
