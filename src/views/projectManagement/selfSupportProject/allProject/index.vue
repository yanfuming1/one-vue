        ...
        <template slot="header">
            <div class="qqt-container-full-header___top">
                <span class="qqt-container-full-header___search">
                    ...
                    <el-button type="primary" class="qqt-container-full-header-top___button" @click="searchModelSynopsis(1,10)">搜索</el-button>
                ...
                <span class="qqt-container-full-header-operation___right">
                    <el-button type="success" class="qqt-container-full-header-top___button" @click="shareProject">共享</el-button>
                </span>
                <span class="qqt-container-full-header-operation___right">
...
import { selfProjectPageList, selfProjectDelete, getSelfProjectHighestVersion, updataSelfProjectAttention} from '../../../../api/selfProject/allProject/index'
...
export default {
                            ...
                            h('el-button', {
                                ...
                                on:{
                                    click: () => {
                                        ...
                                        this.routerLink('newProject', { transform: this.transform, relevancyId: parms.row.id }, '自营项目详情')
                                    }
                                }
                            }, '查看'),
                            h('el-button', {
                                ...
                                on:{
                                    click: () => {
                                        ...
                                        this.routerLink('newProject', { transform: this.transform, relevancyId: parms.row.id }, '自营项目编辑')
                                    }
                                }
                            }, '编辑'),
                        ]
    ...
    methods: {
        newReserve() {
            this.transform.isShowDetails = false
            this.routerLink('newProject', { transform: this.transform, addPro: true,}, '新建自营项目')
        },
        ...
        searchModelSynopsis(pageNo = '1', pageSize = '10') {
            ...
            selfProjectPageList(this.filterForm).then(res => {
                this.tableData = res
            })
        },
