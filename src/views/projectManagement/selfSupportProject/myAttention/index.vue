...
import { getSelfProjectAttentionList, selfProjectDelete, getSelfProjectHighestVersion, updataSelfProjectAttention} from '../../../../api/selfProject/allProject/index'
...
export default {
    ...
    methods: {
        ...
        searchModelSynopsis(pageNo = '1', pageSize = '10') {
            ...
            getSelfProjectAttentionList(this.filterForm).then(res => {
                this.tableData = res
            })
        },
        ...
        getList(){
            getSelfProjectAttentionList().then(res => {
                this.tableData = res
            })
        },
        shareProject(){
