...
<!-- 联营人账户 -->
    <d2-container>
        <template>
            <div class="associate-account-header" slot="header">
                ...
                <el-row>
                    <el-col :span='11'>
                        <el-form-item label="账户类型:" prop="accountType">
                            <el-input :disabled="true" placeholder="联营人账户"></el-input>                          
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>      
                            ...
                            on: {click: () => {
                                ...
                                getCompanyEmployeeAccountById ({'id': params.row.id}).then (res => {
                                    if (res) {
                                        ...
                                        this.bankAccountDetailsData.accountType = "联营人账户"
