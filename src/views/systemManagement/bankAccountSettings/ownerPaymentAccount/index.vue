...
<!-- 业主付款账户 -->
    <d2-container>
        <template>
            <div class="owner-payment-account-header" slot="header">
            ...
            <template>
                <qqt-table :data="employeeAccountsData" :rowHeader="rowHeader" :option="tableOption" :dynamicHeader="dynamicHeader" @selectionChange="selectChange"  @page="handlePaginationChange"></qqt-table>
            </template>
        
        </template>
        <el-dialog title="新建账户" :visible.sync="dialogFormVisible" :data="newAccountData">
                ...
                <el-row>
                    <el-col :span='11'>
                        <el-form-item label="账户类型:" prop="accountType">
                            <el-input placeholder="业主付款账户" :disabled="true"></el-input>                          
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>      
           ...
           <!--编辑账户弹框 -->
        <el-dialog title="编辑账户" :visible.sync="editFormVisible" :data="editAccountData">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button  @click="editFormVisible = false">取 消</el-button>
                        ...
                        <!-- 详情 -->
        <el-dialog title="账户详情" :visible.sync="detailsdialogVisible" width="35%">
            <el-form>
                <el-row>
                    <el-col :span="11">
                            ...
                            on: {click: () => {
                                ...
                                getCompanyEmployeeAccountById ({'id': params.row.id}).then (res => {
                                    if (res) {
                                        ...
                                        this.bankAccountDetailsData.accountType = '业主付款账户'
                                    }
                                })
                                } 
                            }
