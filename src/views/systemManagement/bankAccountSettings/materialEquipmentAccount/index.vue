...
<!-- 物资设备供应商账户 -->
    <d2-container>
        <template>
            <div class="materiale-quipment-account-header" slot="header">
                ...
                <el-row>
                    <el-col :span='11'>
                      <el-form-item label="账户类型:" prop="accountType">
                            <el-input placeholder="物资设备供应商账户" :disabled="true"></el-input>                          
                        </el-form-item>
                    </el-col>
                    <el-col :span="11" :offset='2'>
...
export default {
    data() {
        return {
            ...
            rules: {
                ...
                nature: [{required: true, message: "请选择账户性质",   trigger: 'change'}],
                untitled1:  [
                            ...
                            on: {click: () => {
                                ...
                                getCompanyEmployeeAccountById ({'id': params.row.id}).then (res => {
                                    if (res) {
                                        ...
                                        this.bankAccountDetailsData.accountType = '物资设备供应商账户'
                                    }
                                })
                                } 
                            }
    ...
    methods: {
        ...
        newAccountEvent () {
            let that = this;
            if ( that.newAccountData.nature === '') {
                that.$message.warning("请选择账户性质")
                return
            } else {
        ...
        getCompanyEmployeeAccount (id) {
            if ( that.editAccountData.nature === '') {
                that.$message.warning("请选择账户性质")
                return
            } else {
...
<style lang="scss">
.materiale-quipment-account-header{
    margin-bottom: -25px
}
</style>
