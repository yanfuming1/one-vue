...
<!-- 公共资源交易中心账户 -->
    <d2-container>
        <template>
            <div class="resource-trading-account-header" slot="header">
                ...
                <el-row>
                    <el-col :span='11'>
                        <el-form-item label="账户类型:" prop="accountType">
                            <el-input placeholder="公共资源交易中心账户" :disabled="true"></el-input>                          
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>      
                            ...
                            on: {click: () => {
                                ...
                                getCompanyEmployeeAccountById ({'id': params.row.id}).then (res => {
                                    if (res) {
                                        ...
                                        this.bankAccountDetailsData.accountType = '公共资源交易中心账户'
                                    }
                                })
                                } 
                            }
...
<style lang="scss">
.resource-trading-account-header{
    margin-bottom: -25px
}
</style>
