...
export const hiprint = function (t) {
    ...
    var _entity_PrintElementEntity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17),
        ...
        BasePrintElement = function () {
            ...
            return BasePrintElement.prototype.getConfigOptionsByName = function (t) {
                ...
                return false ? new _entity_PrintElementEntity__WEBPACK_IMPORTED_MODULE_0__.a(void 0, this.options.getPrintElementOptionEntity(), this.printElementType.getPrintElementTypeEntity()) : new _entity_PrintElementEntity__WEBPACK_IMPORTED_MODULE_0__.a(this.printElementType.tid, this.options.getPrintElementOptionEntity());
        ...
        TableExcelHelper = function () {
            ...
            return TableExcelHelper.createTableHead = function (t, e) {
                ...
                t.rowColumns.forEach(function (t, i) {
                    var r = $("<td></td>");
                    t.field && r.attr("field", t.field ? t.field : t.columnId), t.align && r.css("text-align", t.align), t.vAlign && r.css("vertical-align", t.vAlign);
                    var a = TableExcelHelper.getColumnFormatter(t),
                        p = a ? a(e[t.field ? t.field : t.columnId], e, i, n) : e[t.field ? t.field : t.columnId];
                    r.html(p);
                    var s = TableExcelHelper.getColumnStyler(t);
                    if (s) {
                        var l = s(e[t.field ? t.field : t.columnId], e, i, n);
    ...
    !function (t) {
        ...
        function i(i) {
            ...
            o.hidroppables = a;
            var p = o.proxy;
            return p || (r.proxy ? (p = "clone" == r.proxy ? t(i.data.target).clone().insertAfter(i.data.target) : r.proxy.call(i.data.target, i.data.target), o.proxy = p) : p = t(i.data.target)), p.css("position", "absolute"), e(i), n(i), r.onStartDrag.call(i.data.target, i), !0;
        }
    ...
    var _r,
        ...
        G = function (t) {
            ...
            return K(e, t), e.prototype.getPrintElementOptionEntity = function () {
                var e = t.prototype.getPrintElementOptionEntity.call(this);
        ...
        pt = function () {
            ...
            return t.prototype.design = function (t) {
                ...
                this.designPaper.getTarget().on("mousemove", function (e) {
                    ...
                    s.a.instance.draging || (t.mouseRect && t.mouseRect.target && t.mouseRect.target.remove(), 1 === e.buttons && (t.mouseRect = new at(e.pageX, e.pageY, 0, 0)));
                });
                ...
                this.mouseRect.target || (this.mouseRect.target = $('<div style="z-index:2;position: absolute;opacity:0.2;border: 1px dashed #000;background-color:#31676f;"></div>'), n.append(this.mouseRect.target), this.mouseRect.target.hidraggable({
                    onDrag: function onDrag(t, n, i) {
                    ...
                    minMove: p.a.instance.movingDistance,
                    onBeforeDrag: function onBeforeDrag(t) {
                        s.a.instance.draging = !0, e.mouseRect.mouseRectSelectedElement = e.getElementInRect(e.mouseRect);
                    },
                    onStopDrag: function onStopDrag(t) {
                        s.a.instance.draging = !1;
                    }
                    ...
                    left: t.minX - n.offset().left + "px",
                    top: t.minY - n.offset().top + "px"
                });
            }, t;
        }(),
        st = function () {
